        ...
        <>
            ...
            <Modal className="" dismissible show={openModal} onClose={() => setOpenModal(false)}>
                ...
                <button onClick={() => setOpenModal(false)} className="flex justify-center items-center w-full h-screen">
                    <iframe onClick={() => setOpenModal(true)} className="w-full h-full aspect-video overflow-hidden rounded-lg" src="https://www.youtube.com/embed/kmu7fEW-Pio?si=Iy9ArOsN3v9Ckn-_/autoplay=1" title="YouTube video player" frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin"></iframe>
                </button>
            </Modal>
        </>
    );
