        ...
        <div className="grid grid-cols-1 w-full p-4">
            <div className="w-full h-full bg-cover aspect-video rounded-lg overflow-hidden" style={{ backgroundImage: "url('https://plus.unsplash.com/premium_photo-1664474619075-644dd191935f?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aW1hZ2V8ZW58MHx8MHx8fDA%3D')" }}>
                <div className="w-full h-full bg-gradient-to-b from-transparent via-black/50 to-black/70 flex flex-col justify-between">
                    <div className=""></div>
                    <div className="m-3">
                        <p className="text-xs text-primary leading-none">Category</p>
            ...
            <div className="">
                <h1 className="text-2xl font-semibold my-2">Program A</h1>
                <p className="text-sm text-gray-400 leading-tight tracking-tight">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas pariatur eveniet animi et quo doloribus atque commodi, reiciendis error ipsa iure, repellat iste quidem! Consequuntur commodi consectetur dicta itaque fugiat.</p>
